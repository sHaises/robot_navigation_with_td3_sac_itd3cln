...
from train_velodynbe_node_iTD3 import CLN, itd3,Actor,Critic
import time
...
if __name__ == '__main__':
    ...
    file_name = "itd3_velodyne"  # name of the file to load the policy from
    environment_dim = 20
    robot_dim = 4
    ...
    # Create the network
    network = iTD3_CLN(state_dim, action_dim)
    try:
